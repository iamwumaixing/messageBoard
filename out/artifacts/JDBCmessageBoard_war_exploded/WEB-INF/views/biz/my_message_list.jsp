        ...
        <c:forEach items="${messages}" var="msg">
            <div class="alt-item">
                ...
                <div class="alt-content">
                        <h3>${msg.title}</h3>
                        <p name="content">${msg.content}</p>
                        <div id="fatie">
                            <a href="/alterMessagePrompt.do?title=${msg.title}&content=${msg.content}&id=${msg.id}"><button>修改</button></a>
                            <a href="/deleteMessage.do?id=${msg.id}"><button>删除</button></a>
                        </div>
                </div>
            </div>
        </c:forEach>
